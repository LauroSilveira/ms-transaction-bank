...
```
> * Note that the configurations of user and password database are referenced on a file, replace them with your database details password, or put 
> these values in the following file: `.env.example`
